...
static void PrintUsage()
{
    ...
    Console.WriteLine("  dotnet run --project Tools/IonMotion.AtlasPacker -- --input <dir> --out <basePath> [--maxSize 2048] [--padding 2] [--extrude 1]");
    Console.WriteLine("  dotnet run --project Tools/IonMotion.AtlasPacker -- --project <project.json>");
    Console.WriteLine();
    Console.WriteLine("Example:");
    Console.WriteLine("  dotnet run --project Tools/IonMotion.AtlasPacker -- --input resources/data/textures/ts1 --out resources/_gen/atlases/ts1");
    Console.WriteLine("  dotnet run --project Tools/IonMotion.AtlasPacker -- --project resources/pipeline/atlases/pack.project.json");
}
