...
static void PrintUsage()
{
    ...
    Console.WriteLine("  dotnet run --project Tools/IsometricMagic.NormalMapGenerator -- --input <file|dir> [--strength 1.0] [--suffix _normal] [--overwrite false]");
    Console.WriteLine("  dotnet run --project Tools/IsometricMagic.NormalMapGenerator -- --project <project.json>");
    Console.WriteLine();
