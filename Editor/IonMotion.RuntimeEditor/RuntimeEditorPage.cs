...
namespace IonMotion.RuntimeEditor
{
    internal static class RuntimeEditorPage
    {
        ...
        private static string LoadHtml()
        {
            ...
            {
                return "<!doctype html><html><body><h1>IonMotion: Runtime Editor</h1><p>Missing embedded SPA.</p></body></html>";
            }

            using var stream = assembly.GetManifestResourceStream(resourceName);
            if (stream == null)
            {
                return "<!doctype html><html><body><h1>IonMotion: Runtime Editor</h1><p>Missing embedded SPA stream.</p></body></html>";
            }
